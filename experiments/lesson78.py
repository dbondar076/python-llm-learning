...
def rule_based_answer_pass(answer: str, required_terms: list[str]) -> bool:
...
async def main() -> None:
    ...
    for case in cases:
        ...
        answer_pass = rule_based_answer_pass(actual_answer, required_terms)
        ...
        print("REQUIRED TERMS:", required_terms)
    ...
    print(f"Rule-based Answer Accuracy: {answer_hits}/{total}")
